...
public class Example {
    ...
    public static void main(String[] args) {        
        ROSBridgeClient client = new ROSBridgeClient("ws://192.168.0.118:9090");
        client.connect();
        testTopic(client);
        try {
        //testService(client);
    ...
    public static void testTopic(ROSBridgeClient client) {
        ...
        Clock cl = new Clock();
        cl.clock = new TimePrimitive();
        cl.clock.secs = 2;
        try {
            clockTopic.publish(null);
            cl.clock.nsecs= 1;
            clockTopic.publish(null);
            cl.clock.nsecs= 1;
    ...
    public static void testLogger(ROSBridgeClient client) {
